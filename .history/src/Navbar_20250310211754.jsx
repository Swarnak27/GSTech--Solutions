...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setIsScrolled(window.scrollY > 50); // Set the threshold to 50px or adjust as needed
    };
  ...
  return (
    <header
      className={`fixed top-0 z-50 w-full transition-all duration-500 ease-in-out text-white ${
      ...
      style={{
        ...
        height: isScrolled ? "50px" : "80px", // Adjust the height dynamically based on scroll
      }}
    >

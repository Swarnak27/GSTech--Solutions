      ...
      <div className="container space-y-3 relative z-20">
        ...
        <div className="flex gap-x-4 gap-y-8 pt-8 flex-wrap justify-center">
          ...
          <div className="w-[300px] relative px-4 pt-5 pb-3 bg-white rounded-lg shadow border-l-4 border-b-4 space-y-1 item" style={{ borderColor: "rgb(150, 246, 85)" }}>
            <div className="absolute -top-5 left-5 px-1 py-1 h-12 w-12 rounded flex items-center justify-center" style={{ backgroundColor: "rgb(150, 246, 85)" }}>
              <Lottie animationData={cloudAnimation} loop={true} autoplay={true} height={60} width={60} />
            </div>
          ...
          <div className="w-[300px] relative px-4 pt-5 pb-3 bg-white rounded-lg shadow border-l-4 border-b-4 space-y-1 item" style={{ borderColor: "rgb(150, 246, 85)" }}>
            <div className="absolute -top-5 left-5 px-1 py-1 h-12 w-12 rounded flex items-center justify-center" style={{ backgroundColor: "rgb(150, 246, 85)" }}>
              <Lottie animationData={aiAnimation} loop={true} autoplay={true} height={60} width={60} />
            </div>
          ...
          <div className="w-[300px] relative px-4 pt-5 pb-3 bg-white rounded-lg shadow border-l-4 border-b-4 space-y-1 item" style={{ borderColor: "rgb(150, 246, 85)" }}>
            <div className="absolute -top-5 left-5 px-1 py-1 h-12 w-12 rounded flex items-center justify-center" style={{ backgroundColor: "rgb(150, 246, 85)" }}>
              <Lottie animationData={consultingAnimation} loop={true} autoplay={true} height={60} width={60} />
            </div>
          ...
          <div className="w-[300px] relative px-4 pt-5 pb-3 bg-white rounded-lg shadow border-l-4 border-b-4 space-y-1 item" style={{ borderColor: "rgb(150, 246, 85)" }}>
            <div className="absolute -top-5 left-5 px-1 py-1 h-12 w-12 rounded flex items-center justify-center" style={{ backgroundColor: "rgb(150, 246, 85)" }}>
              <Lottie animationData={securityAnimation} loop={true} autoplay={true} height={60} width={60} />
            </div>
          ...
          <div className="w-[300px] relative px-4 pt-5 pb-3 bg-white rounded-lg shadow border-l-4 border-b-4 space-y-1 item" style={{ borderColor: "rgb(150, 246, 85)" }}>
            <div className="absolute -top-5 left-5 px-1 py-1 h-12 w-12 rounded flex items-center justify-center" style={{ backgroundColor: "rgb(150, 246, 85)" }}>
              <Lottie animationData={systemAnimation} loop={true} autoplay={true} height={60} width={60} />
            </div>

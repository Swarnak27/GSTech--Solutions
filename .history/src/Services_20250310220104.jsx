...
import helpdeskAnimation from "./assets/icon-json/Helpdesk.json";  // Correct animation import
...
const serviceData = [
  ...
  {
    animation: helpdeskAnimation,
    title: "Helpdesk & Support",  // Correct title
  },
];
...
const ServiceCard = ({ animation, title }) => {
  return (
    ...
    >
      <div
        className="flex justify-center mb-4" // Center the icon
      >
        <div
          className="px-2 py-2 h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 lg:h-28 lg:w-28 rounded-full flex items-center justify-center"

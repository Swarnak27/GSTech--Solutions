...
import AboutImg from "./assets/about-us.jpg"; // Import the About Us image
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-20">
        <div className="flex flex-col gap-8 sm:flex-row">
          {/* Image Section */}
          <div className="h-52 w-full sm:h-auto sm:min-w-44 sm:max-w-md sm:grow">
            <picture>
          ...
          {/* Text Section */}
          <div data-section="about-subsection" className="text-white">

...
const Navbar = () => {
  ...
  return (
    <header
      className={`fixed top-0 w-full py-4 z-50 transition-all duration-300 text-white ${isScrolled ? "bg-gray-900 py-2" : "bg-transparent"}`}
      style={{
        boxShadow: isScrolled ? "0px 4px 6px rgba(0,0,0,0.1)" : "none", // Adds shadow after scroll
      }}
    >
      <div className="container mx-auto flex justify-between items-center gap-4">
        ...
        {/* Desktop - Contact Us and Capability Statement Buttons */}
        <div className="flex items-center gap-4">
          {/* Contact Us Button (without background) */}
          <a
          ...
          {/* Capability Statement Button with Green Background */}
          <a
            className="rounded-full px-4 py-3 font-bold duration-300 bg-green-500 text-white"
            target="_blank"

      ...
      <div className="container space-y-3">
        ...
        <div className="space-y-8 mt-8">
          <div className="flex flex-col sm:flex-row sm:flex-wrap gap-8 justify-center">
            <div className="flex items-start gap-x-4 gap-y-8 w-full sm:w-[calc(50%-1rem)] md:w-[calc(33%-1rem)]">
              <div className="w-6 h-6 bg-white text-black flex items-center justify-center rounded-full shadow font-bold">
                1
              </div>
